...
<ul class="social_icon">
    ...
    <!-- Icône Github -->
    <li><a href="#"> <img src="/public/icons/github.svg" alt="logo github" class="w-[32px]"> </a></li>

    <!-- Icône Mail -->
    <li><a href="#"> <img src="/public/icons/linkedin.svg" alt="logo Linkedin" class="w-[32px]"> </a></li>

    <!-- Icône Linkedin -->
    <li><a href="#"> <img src="/public/icons/mail.svg" alt="logo Mail" class="w-[32px]"> </a></li>
...
footer .wave {
    ...
    width: 100%;
    height: 100px;
    background: url(/public/imgs/wave.png);
